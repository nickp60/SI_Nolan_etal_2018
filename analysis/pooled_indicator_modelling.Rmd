...
- There is no difference between the rate of die-off in either pre-pasteruoization conditions
- Both pre-pasteruization conditions show ~1 log lower *E. coli* counts than the other contitions, but no change in the other two FIO.
- There appears to be a slight decrease in starting coliforms in the P4 post-pasteurized condition, but as the 95% CIs overlap with the 10L reactors, we cannot confirm that this difference is relavent.
- The P3 post-pasteurization treatment appears to have a decreased rate of dieoff of E. coli and coliforms.
-  There is no rate difference for P4.

From this, we can confirm that there is no difference in die-off between the 50ml batches and the 10L lab-scale bioreactors.  Pre and Post-pasteurization does not effect alll FIO equally; prepasteurization  
...
- Enterococci decreases slightly over time, euqlally across all the conditions.
- Post pasteurization shows a significantly lower intercept comparing coliform unpasterized conditions to the post-pasteurized treatments.  This trend was similar for the other FIO, but not significant.  
- Pre-pasteurization apears to have no effect on the intercept.
