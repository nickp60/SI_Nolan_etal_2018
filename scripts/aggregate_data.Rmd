...
```
# Data Fix Checklist
Through this sanity checking, we discovered some minor errors in calculations that need to be corrected in the Plots, Discussion, etc:

## Methane
- Combined methane percent (fix wrong values being averaged)
- Decide whether to average at the partial level or at the techrep level

## CFUs
- fix rounding errors when averaging and converting to/from log scale
- fix E coli averaging errors at day 0

## COD
- find where the $*4000$ term comes from in the calculations
